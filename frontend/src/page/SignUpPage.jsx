  ...
  return (
    <div className='min-h-[calc(100vh-64px)] grid lg:grid-cols-2 bg-gray-950 text-gray-100 overflow-hidden relative'>
        <div className="flex flex-col justify-center items-center p-6 sm:p-12 relative z-10">
          ...
          <div className="w-full max-w-md bg-gray-900/60 backdrop-blur-xl border border-gray-800/80 p-8 sm:p-10 rounded-2xl shadow-2xl space-y-6">
            {/* Logo */}
            <div className="text-center mb-4">
              <div className="flex flex-col items-center gap-2 group">
                ...
                <h1 className="text-3xl font-extrabold mt-3 text-white tracking-tight">Create Account</h1>
                <p className="text-gray-400 text-sm">Join LeetLab to start solving</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="form-control">
                <label className="label py-1">
                  <span className="label-text font-medium text-gray-300">Name</span>
                </label>
              ...
              <button
                type="submit"
                className="btn bg-indigo-600 hover:bg-indigo-500 text-white font-bold border-none w-full py-3 rounded-xl transition-all duration-200 hover:scale-[1.01] shadow-lg shadow-indigo-600/10 mt-2"
                disabled={isSigninUp}
              >
                 {isSigninUp ? (
                  <>
            ...
            <div className="text-center pt-2">
              <p className="text-gray-400 text-sm">
                ...
                <Link to="/login" className="text-indigo-400 font-bold hover:underline transition-all duration-150">
                  Sign in
                </Link>
              </p>
            </div>
